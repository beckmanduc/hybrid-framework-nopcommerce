...
public class UserRegisterPageObject extends BasePage  {
	...
	public String getConfirmPasswordErrorMessage() {
		waitForElementVisible(driver, UserRegisterPageUI.COFIRM_PASSWORD_ERROR_MESSAGE);
		return getElementText(driver, UserRegisterPageUI.COFIRM_PASSWORD_ERROR_MESSAGE);
	}
